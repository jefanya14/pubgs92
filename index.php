...
.slideshow-container {
  ...
  position: relative;
  margin: auto;
  border-top: 1px solid #1FAAD3;
  border-bottom: 1px solid #1FAAD3;
}
.fade {
...
.balance {
	...
	margin-bottom: 7px;
	padding: 4px;
	border-top:2px solid #1FAAD3;
	border-left:2px solid #1FAAD3;
	border-right:2px solid #1FAAD3;
	border-bottom:2px solid #1FAAD3;
	display: block;
}
.balance-img {
	width: 50%;
...
<div class="slider animated fadeIn">ID 5149470362 Successful Get Imperial Splendor - M416 </div>
...
<div class="slider animated fadeIn">ID 551627559 Successful Get 10 Materials</div>
<div class="slider animated fadeIn">ID 576760016 Successful Get 8 Materials</div>
<div class="slider animated fadeIn">ID 5226032560 Successful Get 3 Materials</div></div></div> <!--- event-notification --->
